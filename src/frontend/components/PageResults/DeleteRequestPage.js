  ...
  return (
    <div className='deleteRequestContainer'>
      <div className='column'>
        <Button type="hollow-primary" className='buttonGreen' onClick={(e) => props.cancelDeleteRequestPage(e)}>{strings.results.cancel}</Button>
        <p>{strings.results.cancel_message}</p>
      </div>
      <div className='column'>
        <Button type="hollow-primary" className='buttonRed'>{strings.results.remove_WTM}</Button>
