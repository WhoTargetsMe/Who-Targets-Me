...
const strings = new LocalizedStrings({
  en: {
    ...
    register: {
      ...
      consent1: '<span>I have read and agree to the <a href="https://whotargets.me/en/privacy-policy/" target="_blank"> terms and conditions</a>.</span>',
      consent2: '<span>I have read the <a href="https://whotargets.me/en/privacy-policy/" target="_blank">privacy policy</a>. I give my consent to the collection and processing of my personal data.</span>',
      consent3: '<span>I explicitly give my consent to the collection of my personal information as set out in the <a href="https://whotargets.me/en/privacy-policy/" target="_blank">privacy policy</a>.</span>',
    },
    results: {
  ...
  it:{
   ...
   register: {
     ...
     non_us_labels: ['No affiliation', 'Very left wing', 'Moderately left wing', 'Slightly left wing', 'Center', 'Slightly right wing', 'Moderately right wing', 'Very right wing'],
     would_rather_not_say: 'Would rather not say',
     consent1: '<span>Ho letto e accetto le <a href="https://whotargets.me/it/privacy-policy/" target="_blank">condizioni di utilizzo</a>.</span>',
     consent2: '<span>Dopo aver letto <a href="https://whotargets.me/it/privacy-policy/" target="_blank">l’informativa sulla privacy</a> do il mio consenso al trattamento dati.</span>',
     consent3: '<span>Acconsento esplicitamente alla raccolta e trattamento dei miei dati sensibili così come specificato <a href="https://whotargets.me/it/privacy-policy/" target="_blank">nell’informativa sulla privacy</a>.</span>',
   },
   results: {
