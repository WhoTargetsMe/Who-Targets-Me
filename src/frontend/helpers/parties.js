...
export const availableParties = {
  'GB': [
      ...
      {entityId: 3, party:'Liberal Democrats', shortName: 'LD', color: '#FAA61A'},
  ...
  'IE': [
    ...
    {entityId: 7, party:'People Before Profit', shortName: 'PBP', color: '#E5E500'},
  ...
  'PL': [
    ...
    {entityId: 2, party:'Koalicja Obywatelska (PO .N iPL Zieloni)', shortName: 'KO', color: '#fdb300'},
    {entityId: 3, party:'Lewica (SLD, Wiosna, Razem)', shortName: 'LEW', color: '#610B5E'},
    {entityId: 4, party:'Koalicja Polska (PSL, Kukiz`15)', shortName: 'PSL', color: '#3EB43D'},
    {entityId: 5, party:'Konfederacja Wolność i Niepodległość', shortName: 'KON', color: '#122948'},
