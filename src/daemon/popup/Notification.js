...
export const initPopup = function () {
  $(function () {
    ...
    $(
      "body"
    ).append(`<div id="popup_container" style="position:absolute; display:flex; flex-flow: row nowrap; align-items:flex-start;right:0; top:0; width:250px; font-size: 12px; background-color:#f2f2f2;z-index:2000; border:1px solid grey;box-shadow: 2px 2px 2px grey;padding:10px 10px 10px 15px;" onclick="$("#popup_container").hide();">
